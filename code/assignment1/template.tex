...
\begin{itemize}
    \item C: Regularization parameter. Sampled from a uniform distribution between 0.001 and 1000.
    \item Kernel: Kernel type to be used in the algorithm. Values tested: ['linear', 'rbf', 'poly', 'sigmoid']
    \item Gamma: Kernel coefficient for 'rbf', 'poly' and 'sigmoid'. Sampled from a uniform distribution between 0.001 and 1.0.
\end{itemize}
...
\begin{table}[!htb]
    ...
    \small{
        \begin{tabular}{p{1cm}p{3cm}p{1cm}}
            ...
            4     & Worked on assignment 2 hyperparameter tuning           & 5 hours (training took about 12h in total) \\
            4     & Updated the report for assignment 2                    & 1.5 hours                                  \\
            \midrule
            Total & 27.5 hours                                                                                          \\
...
\begin{table}[h!]
    \centering
    \caption{NER classification report for SVM}
...
I trained my SVM model with word embeddings based on the
...
\begin{table}[h]
    ...
    \begin{tabular}{l c c c c}
        \toprule
        \textbf{Entity Tag}                   & \textbf{Precision} & \textbf{Recall} & \textbf{F1-Score} & \textbf{Support} \\
        \midrule
        ...
        \midrule
        \multicolumn{4}{l}{\textbf{Accuracy}} & \textbf{0.937}                                                              \\
        \midrule
        \textbf{Averages}                     &                    &                 &                   &                  \\
